...
#| error: false
#| message: false
borrowers = read.csv("data/library/fake/borrowers.csv")
books = read.csv("data/library/fake/books.csv")
checkouts = read.csv("data/library/fake/checkouts.csv")
...
left_join(checkouts, books, by="item_id") |>
