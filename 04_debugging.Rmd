...
code or data is to print out lots of text in the console. This section introduces several different functions for printing output
...
interactive prompt. Thus it's not necessary to call `print` to print something when you're
...
The `message` function is the one you should use to print output that is nice to read for users.
There are two reasons: `message` formats its output to be more readable, and it is part of R's
